...
## Upload the ISO to the Portal

<Steps>
  <Step title="Open Installation → Custom Image">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank" rel="noreferrer">EDBB VPS Portal</a>, open your VPS, and switch to <strong>Installation</strong>. Choose the <strong>Custom Image</strong> tab.
  </Step>
