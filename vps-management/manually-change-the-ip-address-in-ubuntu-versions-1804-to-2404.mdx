...
<Steps>
  <Step title="Open the Network tab">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>, open your VPS, and switch to <strong>Network</strong>. Note the IPv4 address, subnet, gateway, and DNS servers.
  </Step>
