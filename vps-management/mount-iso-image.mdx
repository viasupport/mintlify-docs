...
# Mount ISO Images from the Portal
...
<CardGroup cols={3}>
  <Card title="🔐 Portal Access">
    Confirm you can sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a> and open the service dashboard.
  </Card>
...
<Steps>
  <Step title="Open the Installation tab">
    From your VPS dashboard, switch to <strong>Installation</strong>, then the <strong>ISO Boot</strong> sub-tab.
  </Step>
