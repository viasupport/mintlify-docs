...
<CardGroup cols={2}>
  <Card title="🛠️ Fast Maintenance">
    Shortcut buttons for <strong>Reinstall</strong> and <strong>IP Change</strong> now sit beneath the dashboard cards. Use them to reinstall your OS or initiate random or bespoke IP address changes.
