...
<Steps>
  <Step title="Open the Network tab">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>, select your VPS, and open the <strong>Network</strong> tab. Copy the IPv6 assignment and gateway.
  </Step>
