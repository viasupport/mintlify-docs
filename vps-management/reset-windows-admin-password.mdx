...
<CardGroup cols={3}>
  <Card title="🔐 Portal Access">
    Confirm you can sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB Control Panel</a>. You’ll manage the entire workflow from the service dashboard.
  </Card>
