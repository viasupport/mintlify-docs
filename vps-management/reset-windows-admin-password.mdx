---
title: "Set New Windows Administrator Password"
sidebarTitle: "Reset Windows Password"
description: "Boot the Windows password-helper ISO, clear the Administrator password, and assign a new Password in a few minutes."
---
...
<CardGroup cols={3}>
  <Card title="🔐 Control Panel Access">
    Confirm you can sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB Control Panel</a>. You’ll manage the entire workflow from the service Control Panel.
  </Card>
...
<Steps>
  <Step title="Log in">
    Sign in to the EDBB Control Panel, go to <strong>Services</strong>, and open the Windows VPS that needs recovery.
  </Step>
