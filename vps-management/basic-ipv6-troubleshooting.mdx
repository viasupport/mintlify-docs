...
<Steps>
  <Step title="Check the Network tab">
    Open the <strong>Network</strong> tab in the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>. Note the IPv6 assignment, gateway, and recommended DNS resolvers.
  </Step>
