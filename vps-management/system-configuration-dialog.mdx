...
<Steps>
  <Step title="Open the service dashboard">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>, open <strong>Services</strong>, and select the VPS you want to adjust.
  </Step>
  <Step title="Launch System Configuration">
    In the Settings tab, click <strong>System Configuration</strong>. The dialog opens with tabs for each hardware category.
  </Step>
</Steps>
...
You’re ready to tailor the virtual hardware for your workload while staying within the EDBB portal.
