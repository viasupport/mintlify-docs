...
description: "Upload a qcow2 image with Cloud-Init support, supply your user-data, and boot it via the EDBB Installation → Custom Image workflow."
---
...
<Steps>
  <Step title="Open the Installation tab">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>, choose your VPS, and switch to the <strong>Installation</strong> tab.
  </Step>
  ...
  <Step title="Upload the qcow2 file">
    Drag & drop your qcow2 (or click <em>browse</em>). The portal stores the image temporarily for this reinstall.
  </Step>
