...
description: "Turn VNC on or off from the EDBB Control Panel so you can reach the console via Open Console or a desktop VNC client."
---
...
<Steps>
  <Step title="Open the quick action menu">
    ...
    ![VNC access controls in the quick action panel](/assets/enable-vnc.png)
  </Step>
...
![VNC access controls in the quick action panel](/assets/VNC-info.png)
...
![Open console](/assets/vnc-console.png)
---
