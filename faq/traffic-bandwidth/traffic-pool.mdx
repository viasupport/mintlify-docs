...
The balance sheet below (demo data) works like a bank account statement.  
We log **traffic top-ups**, **pool traffic consumption**, and the resulting balance after each transaction.  
This report provides a transparent overview of **traffic pool usage across your entire VPS hosting account**.
...
📩 **We will notify you by email when 80% of your total Traffic Pool balance has been used.**

<CtaButton label="Top-up Traffic Pool" link="https://my.edbb.com/cart.php?gid=214" />
