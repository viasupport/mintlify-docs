...
This credit **never expires**, can be applied to **any VPS in your account**, and can be used **manually** when a server runs out of traffic — or automatically through **Auto Hydration**.
