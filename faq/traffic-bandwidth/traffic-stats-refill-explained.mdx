...
## Find Everything on the Traffic Tab

<Info>
  In the <a href="https://my.edbb.com/clientarea.php" target="_blank" rel="noreferrer">EDBB VPS Portal</a>, open your VPS and switch to the <strong>Traffic</strong> tab. It shows the current cycle, auto-hydration settings, pool balance, and usage charts at a glance.
</Info>
...
Email alerts land at 80%, 90%, and 100%, but the portal indicator is the quickest way to spot high usage.
...
<div style={{display: "flex", gap: "16px", flexWrap: "wrap", alignItems: "stretch"}}>
  <div style={{flex: "1 1 320px"}}>
    <img src="/assets/daily_traffic.png" alt="Daily traffic chart" style={{width: "100%", borderRadius: "16px", border: "1px solid rgba(0,0,0,0.06)"}} />
  </div>
  <div style={{flex: "1 1 320px"}}>
    <img src="/assets/traffic_info-cal.png" alt="Traffic calendar view" style={{width: "100%", borderRadius: "16px", border: "1px solid rgba(0,0,0,0.06)"}} />
  </div>
</div>
...
<Steps>
  <Step title="Grace & throttle">
    After a 5% grace buffer, the NIC is capped at roughly <strong>64 kbit/s</strong>. The VPS stays online but feels slow.
  </Step>
