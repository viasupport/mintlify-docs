...
<Steps>
  <Step title="Open the Add Funds page">
    Sign in to the <a href="https://my.edbb.com/clientarea.php?action=addfunds" target="_blank" rel="noreferrer">EDBB VPS Portal</a> and navigate to <strong>Billing → Add Funds</strong>.
  </Step>
