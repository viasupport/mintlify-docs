...
<CardGroup cols={2}>
  <Card title="📦 Standard change">
    <p>
    <strong>€5</strong>
     per request. The Control Panel assigns the next available IPv4—perfect when you just need a fresh address.</p>
  ...
  <Card title="🎯 Bespoke change">
    <p>
    <strong>€10</strong>
     with a curated list of candidates so you can choose the exact IPv4 that fits your compliance or geolocation requirements.</p>
