...
If you already know which tier you need, click the upgrade shortcut on the service dashboard.

![Quick upgrade button on the dashboard](/assets/Upgrade-right.png)

<Steps>
  <Step title="Open the VPS dashboard">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a> and choose the service you want to scale.
  </Step>
...
<Steps>
  ...
  <Step title="Review and checkout">
    Compare CPU, RAM, storage, and traffic quotas. Select your target plan, pay the prorated invoice, and the portal handles the rest.
  </Step>
</Steps>
