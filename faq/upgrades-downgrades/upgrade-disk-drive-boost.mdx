...
<Steps>
  <Step title="Open the service">
    Sign in to the <a href="https://my.edbb.com/clientarea.php" target="_blank" rel="noreferrer">EDBB VPS Portal</a>, head to <strong>Services</strong>, and select the VPS that needs extra space.
  </Step>
