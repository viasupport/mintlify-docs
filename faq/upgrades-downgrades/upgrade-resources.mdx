...
## Order a Component Upgrade via the Portal

<Steps>
  <Step title="Open the VPS dashboard">
    Sign in at the <a href="https://my.edbb.com/clientarea.php" target="_blank">EDBB VPS Portal</a>, go to <strong>Services</strong>, and choose the VPS you want to extend.
  </Step>
