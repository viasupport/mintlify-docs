...
description: "Welcome to EDBB Docs - Essential guides for launching, securing, and managing your VPS."
---
...
<CardGroup cols={4}>
  <Card title="Quick Launch" icon={<StartIcon />} href="/quick-launch">
    Quick-start guides to launch your VPS in minutes
  </Card>
  ...
  <Card title="Reinstall" icon={<ReinstallIcon />} href="/vps-management/autoinstall-reinstall-install-vps-linux-windows">
    Reinstall your OS — Linux or Windows — in one click.
  </Card>
